...
<body id="container-page-index">
    ...
    <div class="jumbotron" id="jumbotron-index">
      <h1><span class="tittles-pages-logo">Vianney Textil Hogar</span> <small style="color: #fff;">Planta Confección</small></h1>
      <p>
          Bienvenido a nuestro departamento de Kaizen en linea, aquí encontrara una gran variedad de artículos para su area de produccion.
      </p>
    </div>
    <section id="new-prod-index">
         <div class="container">
            <div class="page-header">
                <h1>Novedades <small>Muebles, Costales, etc.</small></h1>
            </div>
            <div class="row">
              <?php
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 text-center">
                   <article style="margin-top:20%;">
                        ...
                        <h3>Registrate</h3>
                        <p>Registrese y hagase cliente del <span class="tittles-pages-logo">departamento de Kaizen</span> para recibir nuestros productos.</p>
                        <p><a href="registration.php" class="btn btn-info btn-block">Registrarse</a></p>   
                   </article>
                </div>
                <div class="col-xs-12 col-sm-6">
                    <img src="assets/img/portada.jpg" alt="portada" width="1400" height="1400" class="img-responsive">
                </div>
            </div>
        </div>
    </section>
